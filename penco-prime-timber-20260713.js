...
금속 포인트가 더해진 추가금 옵션까지 총 10가지로 준비되어 있습니다.🎨
...
추가금 옵션 4종은 자사몰 기준 각 1,500원이 추가됩니다.
...
${hashtags}`
  ...
  const product = {
    ...
    cons: [
      ...
      '추가금 옵션 4종은 기본 색상보다 각 1,500원 추가됨',
  ...
  window.BLUEBLACK_PRODUCT_CONTENT = Object.assign(window.BLUEBLACK_PRODUCT_CONTENT || {}, {
    [PRODUCT_ID]: {
      ...
      photo: '전체 색상 단체 컷·기본/추가금 옵션 비교·나무 바디 질감·전용 샤프너 사용·필기선 비교',
