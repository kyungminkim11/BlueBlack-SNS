...
차분하고 클래식한
프로피트 캐주얼 라지 베이시스 만년필 GT까지 만나보실 수 있습니다.
...
${hashtagSets[0]}`,
`🌌 밤하늘을 닮은 세일러 만년필이 입고되었습니다.

깊은 색감과 반짝이는 디테일이 어우러진
세일러 프로기어 셀레스티얼 아웃플로우를
...
또한 세일러의 새로운 프로기어 모델인
셀레스티얼 아웃플로우 21K·14K도
함께 만나보실 수 있습니다. 🌌
...
셀레스티얼 아웃플로우의 화려한 분위기부터
프로피트 캐주얼의 단정한 디자인까지,
서로 다른 매력을 가진 제품들로 준비했습니다.
...
${hashtagSets[4]}`
  ...
  const productContent = {
    ...
    description: '프로기어 셀레스티얼 아웃플로우 21K / 14K와 프로피트 캐주얼 라지 투명 GT, 베이시스 GT의 입고 사실을 먼저 알리고, 프로피트 캐주얼 구매 시 제품 1개당 3·O 베이직 잉크 1병을 증정하는 행사 조건을 함께 전달합니다.',
  ...
  const product = {
    ...
    facts: [
      ...
      { label: '행사 판매처', value: '3·O 베이직 잉크 취급 판매처에 한하여 진행', verified: true }
    ],
    officialImages: [],
    features: [
